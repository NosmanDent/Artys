...
function CartCheckout({ hidden, width }) {
  ...
  return (
    <>
      ...
      <Modal isOpen={modalIsOpen} onRequestClose={toggleModal}>
        <div className="grid grid-cols-2 my-2 text-xs md:text-base">
          ...
          <button
            ...
            className="bg-gray-700 text-white h-[3.5rem] px-8 flex items-center  justify-center"
          >
            REMOVE ITEM
          </button>
        </div>
      </Modal>
      <div className={"w-3/5 mx-auto mt-20 mb-8 hidden  " + hidden}>
      ...
      <main className="flex gap-8 justify-end mb-28">
