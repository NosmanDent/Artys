      ...
      <main>
        <div className="container mx-auto my-28">
          <div className={`max-w-[1064px] mx-auto pb-8`}>
            ...
            <div className="-z-10 absolute  h-[112px] w-[129px] bg-[black] blur-[35px] -right-10 top-[296px]"></div>
            <div className="-z-10 absolute  h-[90px] w-[80px] bg-[#9B62EC] blur-[30px] right-[125px] top-[96px]"></div>
