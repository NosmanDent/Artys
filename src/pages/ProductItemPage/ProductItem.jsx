...
function ProductItem() {
  ...
  return (
    <div>
      <ToastContainer />
      <div className="container mx-auto px-4 md:px-0 pb-20 md:mb-0 mt-20">
          ...
          <main className="md:border flex-col md:flex-row border-grey flex text-grey leading-[97%]">
            ...
            <div className="w-full flex flex-col">
              <div className="flex md:border-b border-b-grey md:px-5 pt-4 md:py-3 justify-between items-center">
                ...
                <div className="hidden md:block text-xl font-medium  items-center">
                  <svg
                    width="53"
                    height="62"
                    viewBox="0 0 53 62"
              ...
              <div className="md:px-5 py-6 grow-1  ">
                ...
                <div className="flex">
                  <button
                    ...
                    className="bg-[blue] disabled:bg-blue/[0.5] rounded-[3px] px-6 md:px-8 h-[3.5rem] flex items-center text-white font-medium"
                  >
