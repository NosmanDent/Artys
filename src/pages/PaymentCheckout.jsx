...
import InputWrapper from "./cart/InputWrapper";
...
function PaymentCheckout() {
  ...
  return (
    <Transitions>
      ...
      <div className={`max-w-[1064px] mx-auto pb-8 px-4 md:px-0 mt-20 mb-28`}>
        <div className="w-3/5 mx-auto mb-8 hidden md:block">
          <button className="text-[#888888] text-lg pb-2 border-b-[0.5px] border-b-[#747474]  w-1/3">
            <Link to="/cart">Shopping cart </Link>
          </button>
          <button className="text-[#888888] text-lg pb-2 border-b-[0.5px] border-b-[#747474]  w-1/3 ">
            <Link to="/shipping-details">Shipping details </Link>
          </button>
          <button className="text-[#888888] text-lg pb-2 border-b-[0.5px] border-b-[#747474]  w-1/3  active-cart-btn">
            Payment details
          </button>
        </div>
        <main>
          ...
          <div className="flex gap-4">
            <form onSubmit={handleSubmit} className=" md:w-1/2">
              <section className="md:shadow-[0px_0px_5px_rgba(0,0,0,0.25)] rounded-[0.5rem] md:p-8">
                ...
                <InputWrapper>
                  ...
                  <div className="text-grey-light focus:outline-0 bg-[#F2F2F2]  border-[0.5px] border-[#747474] rounded-[10px] py-3 px-5 mt-2 w-full flex ">
                    <input
                      type="text"
                      name="walletKey"
                      id="walletKey"
            ...
            <aside className="w-1/2 p-8 hidden md:block">
              <h3 className="text-grey-dark text-lg font-medium  border-b-[0.3px] pb-6 border-b-[#747474]">
                Payment Summary
              </h3>
              <article className="py-8 border-b-[0.3px] border-b-[#747474]">
                ...
                <p className="text-sm text-[#616161] mt-4">
                  Actively linked to Nigeria.
                </p>
              </article>
              <article className="leading-[150%] text-gray-700 py-6 border-b-[0.3px] border-b-[#747474]">
                <p>
                  Expected arrival date: Between 21nd January and 29th January
                  2023
                </p>
              </article>
