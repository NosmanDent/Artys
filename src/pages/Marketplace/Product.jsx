  ...
  return (
    <>
      ...
      {!showAll && (
        <button
          onClick={() => setShowAll(true)}
          className="border border-grey rounded-[10px] py-4 px-[3.75rem] text-2xl font-medium text-grey  mx-auto my-[100px] hidden md:block"
        >
          See more
        </button>
      )}

      <Newsletter className="md:hidden mt-10" />
    </>
  );
}
